...
class MeshExtractor {
 public:
  ...
  void ExtractMeshWithInstance(TsdfVolume *volume, float3 lower_corner,
                   float3 upper_corner,bool is_instance,unsigned char* instanceColorList_gpu, cudaStream_t stream = nullptr);
